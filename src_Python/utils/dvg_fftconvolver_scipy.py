...
class FFT_Convolver2D_Full:
    ...
    def __init__(
        ...
        shape_real: tuple[int, int] = (
            sp_fft.next_fast_len(shape_out[0], real=True),  # type: ignore
            sp_fft.next_fast_len(shape_out[1], real=True),  # type: ignore
        )
    ...
    def convolve(
        ...
        return _irfft_out[self._slice_out]
