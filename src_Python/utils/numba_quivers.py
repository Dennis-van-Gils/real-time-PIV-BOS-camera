...
def demo(
    ...
    for theta_idx, theta in enumerate(thetas):
        ...
        if 1:
            ...
            # cv2.imwrite(f"export_{theta_idx:05d}.png", img)
            cv2.waitKey(1)
...
if __name__ == "__main__":
    ...
    # demo(img_w, img_h, use_color=False, **quiver_kwargs)
    demo(img_w, img_h, colormap_name="jet", **quiver_kwargs)
